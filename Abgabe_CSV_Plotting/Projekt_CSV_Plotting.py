...
Diese Programm lässt sich mit den mitgegebenen CSV <baume.csv>; <Realestate.csv> testen.
Jede andere CSV kann aber natürlich auch verwendet werden.
...
class AuswahlFenster():
    ...
    __plot_choices = [ "scatterplot", "boxplot", "histogram", "plot (x,y)", "step-plot"]
...
def main():
    ...
    for sep in standard_seps:
        ...
        showinfo("FEHLER", "Csv konnte nicht eingelesen werden")
